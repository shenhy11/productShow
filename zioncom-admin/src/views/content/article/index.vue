<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="publishDate" align="center" prop="publishDate" />
      <el-table-column label="status" align="center" prop="status" />
      <el-table-column label="viewCount" align="center" prop="viewCount" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['content:article:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="articleRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="publishDate" prop="publishDate">
          <el-input v-model="form.publishDate" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="status" prop="status">
          <el-input v-model="form.status" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="viewCount" prop="viewCount">
          <el-input v-model="form.viewCount" placeholder="请输入内容" />
        </el-form-item>
